...
const commonFilter: Omit<Filter, 'bounds' | 'id'> = {
    ...
    buildingTypes: [],
    roomFloors: [RoomFloor.higher],
    roomCounts: [RoomCount.oneRoom, RoomCount.twoRooms, RoomCount.threeAndMoreRooms],
...
const candidates: Filter[] = [
    ...
    },
    {
        ...
        ...commonFilter,
        bounds: {
            max: { lat: 37.512414, lng: 127.016905 },
            min: { lat: 37.503495, lng: 127.026407 },
        },
    },
    {
        id: '회사 근처',
